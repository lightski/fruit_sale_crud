...
$fruit_items = array("navel_orang_full" => array("name" => "Navel Oranges Full Box", "price" => 0.00, "profit" => 0.00, "amount" => 0, "amount" => 0),
				     ...
				     "braeb_full" => array("name" => "Braeburn Full Box", "price" => 0.00, "profit" => 0.00, "amount" => 0, "amount" => 0),
				     "braeb_half" => array("name" => "Braeburn Half Box", "price" => 0.00, "profit" => 0.00, "amount" => 0, "amount" => 0),
				     "danjo_pears_full" => array("name" => "D'Anjou Full Box", "price" => 0.00, "profit" => 0.00, "amount" => 0, "amount" => 0),
				     "danjo_pears_half" => array("name" => "D'Anjou Half Box", "price" => 0.00, "profit" => 0.00, "amount" => 0, "amount" => 0),
					 "mixed_a" => array("name" => "Mixed Box A", "price" => 0.00, "profit" => 0.00, "amount" => 0, "amount" => 0, "amount" => 0),
				     "mixed_b" => array("name" => "Mixed Box B", "price" => 0.00, "profit" => 0.00, "amount" => 0, "amount" => 0, "amount" => 0),
					 "mixed_c" => array("name" => "Mixed Box C", "price" => 0.00, "profit" => 0.00, "amount" => 0, "amount" => 0, "amount" => 0),
					 "mixed_d" => array("name" => "Mixed Box D", "price" => 0.00, "profit" => 0.00, "amount" => 0, "amount" => 0, "amount" => 0),
				     "gift_l" => array("name" => "Gift Box L", "price" => 0.00, "profit" => 0.00, "amount" => 0, "amount" => 0, "amount" => 0),
				     "gift_s" => array("name" => "Gift Box S", "price" => 0.00, "profit" => 0.00, "amount" => 0, "amount" => 0, "amount" => 0),
					 "gift_lp" => array("name" => "Gift Box LP", "price" => 0.00, "profit" => 0.00, "amount" => 0, "amount" => 0, "amount" => 0),
